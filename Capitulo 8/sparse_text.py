...
def createModifiedFile(input_file, output_file):
    ...
    for line in input_file:
        ...
        # simultaneasly output line to screen and output file
...
print("with all occurrences of hte letter 'e' removed.\n")
...
print()
print(num_removals, "ocurrences of the letter 'e' removed")
