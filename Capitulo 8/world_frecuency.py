...
def countWords(input_file, search_word):
    ...
    """"Returns the number of ocurrences of search_word in the
    ...
    for line in input_file:
        ...
        # scan line until ende of line reached
        while not end_of_line:
            try:
                #search for word in current line
                index = line.index(search_word)

                # if word at start of fline followed by a delimiter
...
# program welcome
print('This program wil display the number of occurrences of a')
print('specified word within a given text file\n')

# opent file to search
...
if num_occurrences == 0:
    print('No occurences of word', "'" + search_word + "'",
          'found in file', file_name)
else:
    print('The word', "'" + search_word + "'", 'occurs',
        num_occurrences, 'times in file', file_name)
