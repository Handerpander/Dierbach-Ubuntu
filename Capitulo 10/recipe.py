...
def getFile():
    ...
    """Returns as a tuple the file name entered by the user and the
        opens file object. If the file exceeds three attempts of opening
    ...
    if num_attempts == 3:
        raise IOError('Exceded number of file open attempts')
...
def removeMeasure(line):
    ...
    """"Returns provided line with any initial digits and fractions
        (and any surrounding blanks) removed.
    """
...
def scanAsFraction(line):
    ...
    """"Scans all digits, including fractions and returns as
        Fraction object. For example, '1/2' would return as Fraction
        value 1/2, '2' would return as Fraction 2/1, and '2 1/2' would
        retrun as Fraction value 3/2.
    """
    ...
    while not completed_scan:
        ...
        value_as_frac = value_as_frac + Fraction(numerator,
                                                 denominator)
...
def convertLine(line, factor):
    ...
    """"If line begins with a digit, returns line with the value
        multiplied by factor. Othewise, returns line unaltered
        (e.g., for a factor of 2, '1/4 cup' returns as '1/2 cup'.)
    """
...
try:
    ...
    # open output file named 'con_' + file_name
    output_file_name = 'con_' + file_name
